          ...
          {info &&
            info.map((item) => {
              return (
                <li
                  className={
                    (d === "v" && "hover:text-gray-600 sm:text-sm sm:font-medium sm:w-full sm:hover:text-gray-400 md:text-sm md:font-medium md:w-full md:hover:text-gray-400 hover:underline font-semibold") ||
